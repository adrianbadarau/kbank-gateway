package com.adrianbadarau.bank.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianbadarau.bank.repository..*)" +
            " || within(com.adrianbadarau.bank.service..*)" +
            " || within(com.adrianbadarau.bank.web.rest..*)"
    )
