...
class CacheConfiguration(jHipsterProperties: JHipsterProperties) {
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.adrianbadarau.bank.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.adrianbadarau.bank.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.adrianbadarau.bank.domain.User::class.java.name)
            createCache(cm, com.adrianbadarau.bank.domain.Authority::class.java.name)
            createCache(cm, com.adrianbadarau.bank.domain.User::class.java.name + ".authorities")
