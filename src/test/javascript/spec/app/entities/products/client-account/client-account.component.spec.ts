...
import { ClientAccountComponent } from 'app/entities/products/client-account/client-account.component';
...
describe('Component Tests', () => {
  describe('ClientAccount Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.clientAccounts && comp.clientAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
